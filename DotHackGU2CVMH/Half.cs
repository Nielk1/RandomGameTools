// thanks to http://sourceforge.net/p/csharp-half :)
...
namespace DotHackGU2CVMH//Iridescence
{
    /// <summary>
    ...
    public struct Half : IComparable, IFormattable, IConvertible, IComparable<Half>, IEquatable<Half>
    {
        ...
        /// <summary>
        /// 4 byte conversion structure with a union.
        /// </summary>
        [StructLayout(LayoutKind.Explicit)]
        private struct Binary32
        {
            [FieldOffset(0)]
            public uint UInt;
            [FieldOffset(0)]
        ...
        /// </summary>
        public static readonly Half Epsilon = FromBinary(0x0001);

        /// <summary>
        /// Represents the largest possible value of System.Half. This field is constant.
        /// </summary>
        public static readonly Half MaxValue = FromBinary(0x7bff);

        /// <summary>
        /// Represents the smallest possible value of System.Half. This field is constant.
        /// </summary>
        public static readonly Half MinValue = FromBinary(0xfbff);

        /// <summary>
        /// Represents not a number (NaN). This field is constant.
        /// </summary>
        public static readonly Half NaN = FromBinary(0xfe00);

        /// <summary>
        /// Represents negative infinity. This field is constant.
        /// </summary>
        public static readonly Half NegativeInfinity = FromBinary(0xfc00);

        /// <summary>
        /// Represents positive infinity. This field is constant.
        /// </summary>
        public static readonly Half PositiveInfinity = FromBinary(0x7c00);
        ...
        {
            half.value = (ushort)(half.value ^ 0x8000);
            return half;
        }
        ...
        {
            half1.value = toHalf(toSingle(half1.value) + toSingle(half2.value));
            return half1;
        }
        ...
        public static Half operator ++(Half half)
        {
            half.value = toHalf(toSingle(half.value) + 1.0f);
            return half;
        }
        ...
        public static bool operator <(Half half1, Half half2)
        {
            return toSingle(half1.value) < toSingle(half2.value);
        }
        ...
        {
            return (sbyte)toSingle(value.value);
        }
        ...
        {
            return (byte)toSingle(value.value);
        }
        ...
        {
            return (char)toSingle(value.value);
        }
        ...
        {
            return (short)toSingle(value.value);
        }
        ...
        {
            return (ushort)toSingle(value.value);
        }
        ...
        {
            return (int)toSingle(value.value);
        }
        ...
        {
            return (uint)toSingle(value.value);
        }
        ...
        {
            return (long)toSingle(value.value);
        }
        ...
        {
            return (ulong)toSingle(value.value);
        }
        ...
        {
            return (decimal)toSingle(value.value);
        }
        ...
        {
            return toSingle(this.value).CompareTo(toSingle(other.value));
        }
        ...
        private static uint convertMantissa(uint i)
        {
            ...
            m &= unchecked(~0x00800000u); // Clear leading 1 bit
            e += 0x38800000u; // Adjust bias ((127-14)<<23)
            return m | e; // Return combined number
        }

        private static float toSingle(ushort half)
        {
            Binary32 b32;
            b32.Float = 0.0f;
            b32.UInt = mantissaTable[offsetTable[half >> 10] + (half & 0x3ff)] + exponentTable[half >> 10];
            return b32.Float;
        }

        private static ushort toHalf(float single)
        {
            Binary32 b32;
            b32.UInt = 0u;
            b32.Float = single;
            return (ushort)(baseTable[(b32.UInt >> 23) & 0x1ff] + ((b32.UInt & 0x007fffff) >> shiftTable[b32.UInt >> 23]));
        }
        ...
        public static Half FromBinary(byte[] value, int startIndex)
        {
            return FromBinary(BitConverter.ToUInt16(value, startIndex));
        }
        ...
        public static Half FromBinary(ushort bits)
        {
            Half half;
            half.value = bits;
            return half;
        ...
        {
            return Math.Sign(toSingle(value.value));
        }
        ...
        {
            return FromBinary((ushort)(value.value & 0x7fff));
        }
        ...
        {
            Half half;
            half.value = toHalf(float.Parse(value, CultureInfo.InvariantCulture));
            return half;
        }
        ...
        {
            Half half;
            half.value = toHalf(float.Parse(value, provider));
            return half;
        }
        ...
        {
            Half half;
            half.value = toHalf(float.Parse(value, style, CultureInfo.InvariantCulture));
            return half;
        }
        ...
        {
            Half half;
            half.value = toHalf(float.Parse(value, style, provider));
            return half;
        }
        ...
        {
            return toSingle(this.value).ToString(CultureInfo.InvariantCulture);
        }
        ...
        {
            return toSingle(this.value).ToString(formatProvider);
        }
        ...
        {
            return toSingle(this.value).ToString(format, CultureInfo.InvariantCulture);
        }
        ...
        {
            return toSingle(this.value).ToString(format, formatProvider);
        }
        ...
        {
            throw new InvalidCastException("Invalid cast from 'Half' to 'Char'.");
        }

        DateTime IConvertible.ToDateTime(IFormatProvider provider)
        {
            throw new InvalidCastException("Invalid cast from 'Half' to 'DateTime'.");
        }
        ...
        {
            return (toSingle(this.value) as IConvertible).ToType(conversionType, provider);
        }
